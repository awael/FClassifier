...
XX_test=[]
for image in X:
    XX.append(image.reshape(40*40*3))
for image in X_test:
    XX_test.append(image.reshape(40*40*3))
XX_np = np.array(XX)
...
final_result = []
final_result = knn(X_shuffled,X_shuffled_test,10,Y_shuffled)
...
print('Average Correct Classification Rate: ', total_accuracy,'% - Best K = 10')
